      ...
      <div className="flex justify-between align-middle sm:flex-row flex-col  gap-5">
        <div className="flex border p-6 hover:shadow-md rounded-xl transition duration-300 lg:w-1/2">
          <div className="w-2/3">
            ...
            <p className="text-gray-800 leading-relaxed">
              &quot;<span className="font-bold text-red-600">Spartan mode</span>
              &quot; means <span className="italic">
                an extreme challenge
              </span>{" "}
              that involves{" "}
              <span className="font-bold">
                cutting out all media consumption
              </span>
              , including <span className="font-bold">porn</span>, and
              <span className=" font-bold"> reprogramming </span> the{" "}
              <span className=" font-bold">brain </span>
              to unhook people from
              <span className=" font-bold"> addictive behaviors </span>
              <br />
              <span className="font-bold text-gray-950 text-xl inline-flex mt-3">
                Can you do it?
                <svg
                  id="Layer_1"
                  data-name="Layer 1"
        ...
        <div className=" flex border p-6 hover:shadow-md rounded-xl transition duration-300 lg:w-1/2">
          <div className="w-2/3">
            ...
            <p className="text-gray-800 leading-relaxed">
              <span>
                Make things <span className="font-bold">simpler.</span>{" "}
              </span>
              <br />
              <span>
                Take <span className="font-bold">action.</span> Cut out
                distractions,
              </span>
              <br />
              <span>
                Set <span className="font-bold">goals,</span> understand what
                you truly <span className="font-bold">need?</span>
              </span>

              <br />
              <span>
                Focus on <span className="font-bold"> yourselfs,</span>{" "}
                you&apos;ll become{" "}
